		...
		<div class="container-fluid">
			...
			<div class="navbar-collapse collapse">
				...
				<ul class="nav navbar-nav">
					...
					<li><a href="single.jsp">Simples</a></li>
				</ul>
 				...
 				<article class="post">
					<header class="entry-header">
 						<div class="entry-meta"> 
 							<span class="posted-on"><time class="entry-date published" date="2022-02-16">16 de fevereiro de 2022</time></span>			
 						</div> 
 						<h1 class="entry-title"><a href="single.html" rel="bookmark">Classes e Servlets</a></h1>
					</header> 
					<div class="entry-content"> 
						<p><img alt="" src="assets/images/mac.jpg"></p>
						<p>
							Exemoplo de página<span><b>Model</b></span>.
						</p>
